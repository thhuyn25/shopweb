...
<div>
    <div class="dashboard-header animate-fadeIn">
        <h2 class="dashboard-title"><i class="fas fa-trash me-2"></i>Xóa phản hồi</h2>
        <p class="dashboard-subtitle">Kết quả xóa phản hồi khách hàng</p>
    </div>
    ...
    <div class="dashboard-section animate-fadeIn">
        ...
        <?php endif; ?>
        <a href="/shopweb/quantri/feedback/customer_feedback.php" class="btn btn-outline-secondary">
