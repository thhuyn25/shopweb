...
<div>
    <div class="dashboard-header animate-fadeIn">
        <h2 class="dashboard-title">Quản lý sản phẩm Tops</h2>
        <p class="dashboard-subtitle">Danh sách sản phẩm thuộc danh mục Tops</p>
    </div>
    ...
    if ($conn->connect_error) {
        ...
        $sql_str = "SELECT products.* FROM products JOIN categories ON products.category_id = categories.id WHERE categories.id = 1 ORDER BY products.name";
            ...
            <div class="dashboard-section animate-fadeIn">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Danh sách sản phẩm Tops</h5>
                    </div>
