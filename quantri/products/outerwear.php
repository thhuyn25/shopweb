...
<div>
    <div class="dashboard-header animate-fadeIn">
        <h2 class="dashboard-title">Quản lý sản phẩm Outerwear</h2>
        <p class="dashboard-subtitle">Danh sách sản phẩm thuộc danh mục Outerwear</p>
    </div>
    ...
    if ($conn->connect_error) {
        ...
        $sql_str = "SELECT * FROM products WHERE category_id = 3 ORDER BY name";
            ...
            <div class="dashboard-section animate-fadeIn">
                <div class="card">
                    <div class="card-header">
                        <h5 class之前的5 class="mb-0">Danh sách sản phẩm Outerwear</h5>
                    </div>
                                    ...
                                    <?php if (empty($result)): ?>
                                        <tr>
                                            <td colspan="4" class="text-center py-5">
                                                <i class="fas fa-jacket fa-3x text-muted mb-3"></i>
